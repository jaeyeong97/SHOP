...
export const iconsState = atom<Icon[]>({
  key: "iconsState",
  default: [
    { src: "../assets/top.webp", alt: "상의", path: "/top", label: "상의" },
    { src: "../assets/pants.webp", alt: "하의", path: "/pants", label: "하의" },
    {
    ...
    { src: "../assets/shoes.webp", alt: "신발", path: "/shoes", label: "신발" },
    {
    ...
    { src: "../assets/socks.webp", alt: "양말", path: "/socks", label: "양말" },
    { src: "../assets/bag.webp", alt: "가방", path: "/bag", label: "가방" },
    { src: "../assets/cap.webp", alt: "모자", path: "/cap", label: "모자" },
    {
