...
export const topState = atom({
    key: 'topState',
    default: [
        { id: '상의1', name: '상의 1', price: '35,000', sale: '20%', img: '../assets/top1.webp', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/top1-1.png', '../assets/top1-2.png', '../assets/top1-3.png'] },
        { id: '상의2', name: '상의 2', price: '32,000', sale: '24%', img: '../assets/top2.webp', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/top2-1.png', '../assets/top2-2.png', '../assets/top2-3.png'] },
        ...
        { id: '상의4', name: '상의 4', price: '89,000', sale: '20%', img: '../assets/top4.webp', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/top4-1.png', '../assets/top4-2.png', '../assets/top4-3.png'] },
        ...
        { id: '상의6', name: '상의 6', price: '29,000', sale: '18%', img: '../assets/top6.webp', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/top6-1.png', '../assets/top6-2.png', '../assets/top6-3.png'] },
        ...
        { id: '상의9', name: '상의 9', price: '49,000', sale: '14%', img: '../assets/top9.png', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/top9-1.png', '../assets/top9-2.png', '../assets/top9-3.png'] },
        { id: '상의10', name: '상의 10', price: '34,000', sale: '10%', img: '../assets/top10.png', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/top10-1.png', '../assets/top10-2.png', '../assets/top10-3.png'] },
    ],
});
...
export const pantsState = atom({
    key: 'pantsState',
    default: [
        { id: '하의1', name: '하의 1', price: '62,000', sale: '14%', img: '../assets/pants1.png', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/pants1-1.png', '../assets/pants1-2.png', '../assets/pants1-3.png'] },
        ...
        { id: '하의3', name: '하의 3', price: '38,000', sale: '20%', img: '../assets/pants3.webp', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/pants3-1.png', '../assets/pants3-2.png', '../assets/pants3-3.png'] },
        { id: '하의4', name: '하의 4', price: '47,000', sale: '16%', img: '../assets/pants4.webp', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/pants4-1.png', '../assets/pants4-2.png', '../assets/pants4-3.png'] },
        ...
        { id: '하의6', name: '하의 6', price: '58,600', sale: '20%', img: '../assets/pants6.png', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/pants6-1.png', '../assets/pants6-2.png', '../assets/pants6-3.png'] },
        ...
        { id: '하의8', name: '하의 8', price: '85,600', sale: '20%', img: '../assets/pants8.png', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/pants8-1.png', '../assets/pants8-2.png', '../assets/pants8-3.png'] },
        ...
        { id: '하의10', name: '하의 10', price: '88,400', sale: '10%', img: '../assets/pants10.png', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/pants10-1.png', '../assets/pants10-2.png', '../assets/pants10-3.png'] },
    ],
});
...
export const skirtState = atom({
    key: 'skirtState',
    default: [
        { id: '스커트1', name: '스커트 1', price: '56,000', sale: '20%', img: '../assets/skirt1.webp', size: ['XS', 'S', 'M', 'L'], sImgs: ['../assets/skirt1-1.png', '../assets/skirt1-2.png', '../assets/skirt1-3.png'] },
        { id: '스커트2', name: '스커트 2', price: '66,000', sale: '20%', img: '../assets/skirt2.webp', size: ['XS', 'S', 'M', 'L'], sImgs: ['../assets/skirt2-1.png', '../assets/skirt2-2.png', '../assets/skirt2-3.png'] },
        ...
        { id: '스커트5', name: '스커트 5', price: '52,000', sale: '10%', img: '../assets/skirt5.webp', size: ['XS', 'S', 'M', 'L'], sImgs: ['../assets/skirt5-1.png', '../assets/skirt5-2.png', '../assets/skirt5-3.png'] },
...
export const outerState = atom({
    ...
    default: [
        ...
        { id: '아우터2', name: '아우터 2', price: '185,500', sale: '15%', img: '../assets/outer2.webp', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/outer2-1.png', '../assets/outer2-2.png', '../assets/outer2-3.png'] },
        ...
        { id: '아우터4', name: '아우터 4', price: '275,500', sale: '20%', img: '../assets/outer4.webp', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/outer4-1.png', '../assets/outer4-2.png', '../assets/outer4-3.png'] },
        { id: '아우터5', name: '아우터 5', price: '189,000', sale: '20%', img: '../assets/outer5.png', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/outer5-1.png', '../assets/outer5-2.png',] },
        ...
        { id: '아우터9', name: '아우터 9', price: '299,000', sale: '20%', img: '../assets/outer9.webp', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/outer9-1.png', '../assets/outer9-2.png', '../assets/outer9-3.png'] },
        ...
        { id: '아우터11', name: '아우터 11', price: '282,200', sale: '16%', img: '../assets/outer11.png', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/outer11-1.png', '../assets/outer11-2.png', '../assets/outer11-3.png'] },
        { id: '아우터12', name: '아우터 12', price: '382,800', sale: '20%', img: '../assets/outer12.png', size: ['S', 'M', 'L', 'XL'], sImgs: ['../assets/outer12-1.png', '../assets/outer12-2.png', '../assets/outer12-3.png'] },
    ],
});
...
export const shoesState = atom({
    ...
    default: [
        ...
        { id: '신발2', name: '신발 2', price: '225,000', sale: '12%', img: '../assets/shoes2.webp', size: ['235', '240', '245', '250', '255', '260', '265'], sImgs: ['../assets/shoes2-1.png', '../assets/shoes2-2.png', '../assets/shoes2-3.png'] },
        ...
        { id: '신발4', name: '신발 4', price: '206,500', sale: '20%', img: '../assets/shoes4.webp', size: ['235', '240', '245', '250', '255', '260', '265'], sImgs: ['../assets/shoes4-1.png', '../assets/shoes4-2.png', '../assets/shoes4-3.png'] },
        { id: '신발5', name: '신발 5', price: '165,000', sale: '15%', img: '../assets/shoes5.webp', size: ['235', '240', '245', '250', '255', '260', '265'], sImgs: ['../assets/shoes5-1.png', '../assets/shoes5-2.png', '../assets/shoes5-3.png'] },
...
export const accessoryState = atom({
    key: 'accessoryState',
    default: [
        { id: '주얼리1', name: '주얼리 1', price: '23,500', sale: '17%', img: '../assets/accessory1.webp', color: ['실버', '골드'], sImgs: ['../assets/accessory1-1.png', '../assets/accessory1-2.png', '../assets/accessory1-3.png'] },
        { id: '주얼리2', name: '주얼리 2', price: '34,500', sale: '20%', img: '../assets/accessory2.webp', color: ['실버', '골드'], sImgs: ['../assets/accessory2-1.png',] },
        ...
        { id: '주얼리4', name: '주얼리 4', price: '22,000', sale: '10%', img: '../assets/accessory4.webp', color: ['실버', '골드'], sImgs: ['../assets/accessory4-1.png', '../assets/accessory4-2.png',] },
...
export const eyewareState = atom({
    ...
    default: [
        ...
        { id: '아이웨어2', name: '아이웨어 2', price: '125,000', sale: '18%', img: '../assets/eyeware2.webp', color: ['블랙', '브라운', '그레이', '화이트'], sImgs: ['../assets/eyeware2-1.png', '../assets/eyeware2-2.png',] },
        { id: '아이웨어3', name: '아이웨어 3', price: '124,500', sale: '10%', img: '../assets/eyeware3.webp', color: ['블랙', '브라운', '그레이', '화이트'], sImgs: ['../assets/eyeware3-1.png', '../assets/eyeware3-2.png',] },
...
export const capState = atom({
    key: 'capState',
    default: [
        { id: '모자1', name: '모자 1', price: '52,000', sale: '14%', img: '../assets/cap1.png', color: ['블랙', '브라운', '그레이', '화이트'], size: ['1', '2', '3'], sImgs: ['../assets/cap1-1.png', '../assets/cap1-2.png', '../assets/cap1-3.png'] },
        { id: '모자2', name: '모자 2', price: '55,300', sale: '20%', img: '../assets/cap2.png', color: ['블랙', '브라운', '그레이', '화이트'], size: ['1', '2', '3'], sImgs: ['../assets/cap2-1.png', '../assets/cap2-2.png', '../assets/cap2-3.png'] },
    ],
});
...
export const bagState = atom({
    ...
    default: [
        ...
        { id: '가방2', name: '가방 2', price: '255,100', sale: '16%', img: '../assets/bag2.webp', color: ['블랙', '브라운', '화이트'], sImgs: ['../assets/bag2-1.png', '../assets/bag2-2.png', '../assets/bag2-3.png'] },
        ...
        { id: '가방4', name: '가방 4', price: '198,000', sale: '20%', img: '../assets/bag4.png', color: ['블랙', '브라운', '화이트'], sImgs: ['../assets/bag4-1.png', '../assets/bag4-2.png', '../assets/bag4-3.png'] },
        { id: '가방5', name: '가방 5', price: '218,000', sale: '5%', img: '../assets/bag5.png', color: ['블랙', '브라운', '화이트'], sImgs: ['../assets/bag5-1.png', '../assets/bag5-2.png', '../assets/bag5-3.png'] },
        ...
        { id: '가방8', name: '가방 8', price: '328,000', sale: '10%', img: '../assets/bag8.png', color: ['블랙', '브라운', '화이트'], sImgs: ['../assets/bag8-1.png', '../assets/bag8-2.png', '../assets/bag8-3.png'] },
    ],
});
...
export const socksState = atom({
    ...
    default: [
        ...
        { id: '양말2', name: '양말 2', price: '7,400', sale: '10%', img: '../assets/socks2.webp', color: ['블랙', '브라운', '화이트'], size: ['1', '2', '3'], sImgs: ['../assets/socks2-1.png', '../assets/socks2-2.png',] },
        { id: '양말3', name: '양말 3', price: '6,200', sale: '16%', img: '../assets/socks3.jpg', color: ['블랙', '브라운', '화이트'], size: ['1', '2', '3'], sImgs: ['../assets/socks3-1.png', '../assets/socks3-2.png',] },
